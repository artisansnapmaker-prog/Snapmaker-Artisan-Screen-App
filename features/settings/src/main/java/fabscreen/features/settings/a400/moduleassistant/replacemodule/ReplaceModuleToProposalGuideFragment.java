...
public class ReplaceModuleToProposalGuideFragment extends BaseFragment {
    ...
    public static Fragment newInstance() {
        return new ReplaceModuleToProposalGuideFragment();
    }
    ...
    protected int getLayoutResID() {
        return R.layout.fragment_a400_replace_module_to_proposal_guide;
    }
