...
public class PrintA400AdjustmentRightZOffsetFragment extends BaseFragment {
...
//    SegmentedButtonGroup mSbSteps;
    ...
    public static Fragment newInstance() {
        return new PrintA400AdjustmentRightZOffsetFragment();
    }
    ...
    private void initView() {
        mTvSettingName.setText(R.string.a400_print_print_setting_right_z_offset_title);
        setLinTabValue();
...
//        });
        ...
        mJ1Machine.getFDMController().getZOffset(0)
                ...
                .subscribe(responseStructure -> {
                    if (responseStructure.isSuccess()) {
                        ...
                        ZOffsetInfo zOffsetInfo = zOffsetInfoList.get(1);
    ...
    void onClickZOffsetDown() {
        ...
        mJ1Machine.getFDMController().setZOffset(0, 1, value)
