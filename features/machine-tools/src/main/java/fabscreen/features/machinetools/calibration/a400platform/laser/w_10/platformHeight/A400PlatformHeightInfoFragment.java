...
public class A400PlatformHeightInfoFragment extends A400CalibrationBaseInfoFragment {
    protected IPreferences.Helper helper;

    public static Fragment newInstance() {
        return new A400PlatformHeightInfoFragment();
    }
    ...
    private void routeToPlatformHeightPage() {
        ServiceContainer.getInstance().getService(IRouter.class)
                .routeWithClassPath(RoutePath.TOOLS_CALIBRATION_A400_LASER_10W_PLATFORM_HEIGHT_INFO)
                .start(getContext());
    }
