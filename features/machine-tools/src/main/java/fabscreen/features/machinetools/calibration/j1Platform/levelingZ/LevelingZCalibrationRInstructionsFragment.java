...
public class LevelingZCalibrationRInstructionsFragment extends J1CalibrationBaseFragment {
    ...
    public static Fragment newInstance() {
        return new LevelingZCalibrationRInstructionsFragment();
    }
    ...
    private void initView() {
        mTvShowTitle.setText(R.string.j1_leveling_z_calibration_r_title);
        mTvShowCount.setText(R.string.j1_leveling_z_calibration_r_content);
    }
    ...
    public void onClickNext() {
        ...
        ((LevelingZCalibrationActivity) getActivity()).gotoCalibrationSuccess();
    }
