...
public class A400Laser40wPlatformHeightInfoFragment extends A400CalibrationBaseInfoFragment {
    protected IPreferences.Helper helper;

    public static Fragment newInstance() {
        return new A400Laser40wPlatformHeightInfoFragment();
    }
    ...
    private void routeToPlatformHeightPage() {
        ServiceContainer.getInstance().getService(IRouter.class)
                .routeWithClassPath(RoutePath.TOOLS_CALIBRATION_A400_LASER_40W_PLATFORM_HEIGHT_INFO)
                .start(getContext());
    }
