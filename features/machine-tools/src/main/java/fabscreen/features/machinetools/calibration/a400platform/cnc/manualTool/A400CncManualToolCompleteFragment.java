...
public class A400CncManualToolCompleteFragment extends A400CalibrationBaseFragment {
    ...
    public static Fragment newInstance() {
        return new A400CncManualToolCompleteFragment();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mTvContent.setText(R.string.calibration_cnc_manual_tool_success_msg);
