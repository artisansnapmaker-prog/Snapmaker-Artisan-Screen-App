...
public class LevelingBedCalibrationInfoFragment extends J1CalibrationBaseFragment {
    FDMController mFdmController;
    @BindView(R2.id.btn_next)
    Button mBtNext;

    public static Fragment newInstance() {
        return new LevelingBedCalibrationInfoFragment();
    }
    ...
    void onClickNext() {
        ...
        fabMoving.show();
        mFdmController.setCalibrationMode(1)
                .flatMap(success -> success.isSuccess() ? mFdmController.calibratePointByIndex(1, false) : Observable.just(success))
                ...
                .subscribe(success -> {
                    ...
                    if (success.isSuccess()) {
                        ...
                        ((LevelingBedCalibrationActivity) getActivity()).gotoLevelingBedCalibration1Instructions();
                    }
                });
