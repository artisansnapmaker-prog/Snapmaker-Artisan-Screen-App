...
public class A400CnOriginAssistantCompleteFragment extends A400CalibrationBaseFragment {
    ...
    public static Fragment newInstance() {
        return new A400CnOriginAssistantCompleteFragment();
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mTvTitle.setText(R.string.calibration_cnc_manual_tool_success);
        mTvContent.setText(R.string.calibration_cnc_origin_assistant_success_msg);
