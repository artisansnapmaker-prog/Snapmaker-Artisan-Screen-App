...
public class A400ThicknessMeasurementInfoFragment extends A400CalibrationBaseInfoFragment {
    protected IPreferences.Helper helper;

    public static Fragment newInstance() {
        return new A400ThicknessMeasurementInfoFragment();
    }
    ...
    private void updateView() {
        mIvInfoShow.setImageResource(R.drawable.pic_a400_thickness_measurement_info);
        mTvInfoShowTitle.setText(R.string.a400_calibration_thickness_measurement_title);
        mTvInfoShowContent.setText(R.string.a400_calibration_thickness_measurement_content);
    ...
    public void onClickStart() {
        ...
        DecisionDialog.create(getContext())
                ...
                .setTitle(getString(R.string.calibration_a400_procedure_start_confirm_dialog_title,
                        getString(R.string.a400_calibration_thickness_measurement_title)))
                            ...
                            .subscribe(responseStructure -> {
                                ...
                                if (responseStructure.isSuccess()) {
                                    ServiceContainer.getInstance().getService(IRouter.class)
                                            .routeWithClassPath(RoutePath.TOOLS_CALIBRATION_A400_LASER_THICKNESS_MEASURE_CALIBRATION)
                                            .startForResult(requireActivity(), A400CalibrationActivity.CalibrationType.THK_MEASURE);
                                }
                            }, LogHelper::log);
                })
                .show();
