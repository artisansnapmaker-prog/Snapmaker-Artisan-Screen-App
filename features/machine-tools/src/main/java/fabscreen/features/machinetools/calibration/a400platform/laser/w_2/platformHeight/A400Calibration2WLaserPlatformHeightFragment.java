...
import fabscreen.features.machinetools.calibration.a400platform.laser.w_40.platformHeight.A400Calibration40WLaserPlatformHeightCalibrationActivity;
import fabscreen.features.machinetools.calibration.a400platform.laser.w_40.platformHeight.TouchPlatform40WViewModel;
...
public class A400Calibration2WLaserPlatformHeightFragment extends A400CalibrationBaseFragment {
    ...
    private TouchPlatform2WViewModel mViewModel;

    private StepIntroductionDialog mFocusLeverHelperDialog;
    private boolean mNeedShowTip = true;

    public static Fragment newInstance() {
        return new A400Calibration2WLaserPlatformHeightFragment();
    }
    ...
    private void initView() {
        ...
        mTvContent.setText(R.string.a400_calibration_platform_height_calibration_2w_content);
        ...
        Glide.with(requireContext())
                .load(R.drawable.pic_laser_2w_platform_height_calibration)
                .apply(options)
                .into(mIVImage);
...
//                        mViewModel.changeStepWidth(position);
        ...
        mFocusLeverHelperDialog = StepIntroductionDialog.create(requireContext())
                ...
                .setContent(R.string.a400_calibration_laser_2w_how_to_use_focus_lever_helper_desc)
                .setVideo("/laser_2w_how_to_use_focus_lever.webm")
    ...
    @Override
    protected TouchPlatform2WViewModel getViewModel() {
        return getViewFragmentScopeViewModelProvider().get(TouchPlatform2WViewModel.class);
    }
        ...
        mViewModel.savePlatformZOffset()
                ...
                .subscribe(success -> {
                    ...
                    if (helper.getA400MachineStep(machineSn) == 0) {
                        ...
                        ((A400Calibration2WLaserPlatformHeightCalibrationActivity) getActivity()).gotoComplete();
                    }
                });
    }
}
