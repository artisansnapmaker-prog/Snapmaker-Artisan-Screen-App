...
public class LevelingXYAuxiliaryCalibrationInfoFragment extends J1CalibrationBaseFragment {
    ...
    @BindView(R2.id.iv_text_line_point_4)
    ImageView mIvLine4;
    @BindView(R2.id.tv_text_line_4)
    TextView mTvLine4;
    @BindView(R2.id.iv_text_line_point_2)
    ImageView mIvLine2;
    @BindView(R2.id.tv_text_line_2)
    TextView mTvLine2;
    ...
    @BindView(R2.id.tv_text_line_3)
    TextView mTvTextLine;
    @BindView(R2.id.iv_text_line_point_3)
    ImageView mIvTextLinePoint;
    ...
    public static Fragment newInstance() {
        return new LevelingXYAuxiliaryCalibrationInfoFragment();
    }
    ...
    public void heating() {
        ...
        Observable.zip(mLeftTemperatureState, mRightTemperatureState, LevelingXYAuxiliaryCalibrationInfoFragment::getTemperatureState)
...
//                                .setDescription(R.string.remove_heated_bed_glass)
//                                .setConfirm(R.string.guide_got_it, 3000, (dialog, which) -> {
//                                    dialog.dismiss();
//                                    heating();
//                                })
//                                .show();
                    } else {
                        errorBack("goHome", homeState);
                    }
    ...
    private void initView() {
        Glide.with(this)
                .load(R.drawable.gif_leveling_xy_auxiliary_calibration_info)
                .into(mIvShowImage);
        mIvLine4.setVisibility(View.GONE);
        ...
        Observable.zip(mLeftTemperatureState, mRightTemperatureState, mBedTemperatureState, LevelingXYAuxiliaryCalibrationInfoFragment::getTemperatureState)
                .observeOn(AndroidSchedulers.mainThread())
                .as(bindToLifecycle())
                .subscribe(success -> {
    ...
    void onClickNext() {
        ...
        ((LevelingXYAuxiliaryCalibrationActivity) getActivity()).gotoLevelingXYAuxiliaryCalibration();
    }
