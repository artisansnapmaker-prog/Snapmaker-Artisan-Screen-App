...
public class LevelingZAuxiliaryCalibrationInfoFragment extends J1CalibrationBaseFragment {
    ...
    public static Fragment newInstance() {
        return new LevelingZAuxiliaryCalibrationInfoFragment();
    }
        ...
        fdmController.setExtruderTemperature(0, 0, 220)
                ...
                .subscribe(responseStructure -> {
                    if (responseStructure.isSuccess()) {
                        ...
                        errorBack("heatiing", responseStructure.resultProp.getValue());
                    }
                }, LogHelper::log);

        Observable.zip(mLeftTemperatureState, mRightTemperatureState, LevelingZAuxiliaryCalibrationInfoFragment::getTemperatureState)
    ...
    private void initView() {
        Glide.with(this)
                .load(R.drawable.gif_leveling_z_auxiliary_calibration_info)
                .into(mIvShowImage);
        mIvLine3.setVisibility(View.VISIBLE);
        ...
        Observable.zip(mLeftTemperatureState, mRightTemperatureState, mBedTemperatureState, LevelingZAuxiliaryCalibrationInfoFragment::getTemperatureState)
                .observeOn(AndroidSchedulers.mainThread())
                .as(bindToLifecycle())
                .subscribe(success -> {
        ...
        fdmController.setCalibrationMode(50)
                ...
                .subscribe(success -> {
                    ...
                    if (success.isSuccess()) {
                        ...
                        ((LevelingZAuxiliaryCalibrationActivity) getActivity()).gotoLevelingZAuxiliaryCalibration();
                    } else {
                        errorBack("startZAuxiliaryCalibration", success.resultProp.getValue());
                    }
                }, LogHelper::log);
    }
