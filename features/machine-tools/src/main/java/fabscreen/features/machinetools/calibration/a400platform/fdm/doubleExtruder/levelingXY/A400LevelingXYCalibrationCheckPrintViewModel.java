...
import static fabscreen.features.machinetools.calibration.a400platform.fdm.doubleExtruder.levelingXY.A400LevelingXYCalibrationCheckPrintViewModel.XYCheckPrintState.CHECK_HOME_FAIL;
import static fabscreen.features.machinetools.calibration.a400platform.fdm.doubleExtruder.levelingXY.A400LevelingXYCalibrationCheckPrintViewModel.XYCheckPrintState.INIT_PRINT_FILE_FAIL;
import static fabscreen.features.machinetools.calibration.a400platform.fdm.doubleExtruder.levelingXY.A400LevelingXYCalibrationCheckPrintViewModel.XYCheckPrintState.READY_SUCCESS;
...
public class A400LevelingXYCalibrationCheckPrintViewModel extends BaseViewModel {
    ...
    public A400LevelingXYCalibrationCheckPrintViewModel() {
        super();
...
//    }
    ...
    public Observable<XYCheckPrintState> init() {
    ...
    private File copyPrintFile() {
        InputStream is = mContext.getResources().openRawResource(R.raw.xy_verify_cube_2);
        File file = null;
        try {
