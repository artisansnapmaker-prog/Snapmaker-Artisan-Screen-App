...
public class FabDispatcherHandler extends DispatcherHandler {
    private SessionManager mSessionManager;
    private FabMultipartResolver mMultipartResolver;
    ...
    public FabDispatcherHandler(Context context) {
        super(context);
        this.mSessionManager = new StandardSessionManager(context);
        this.mMultipartResolver = new FabStandardMultipartResolver(context);
    ...
    public void setProgressListener(@NonNull ProgressListener listener) {
        this.mMultipartResolver.setProgressListener(listener);
    }
