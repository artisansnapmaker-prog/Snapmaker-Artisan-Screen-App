...
public class VideoPlayerIJK extends FrameLayout {
    ...
    public void setVideoPath(String path) {
        if (TextUtils.equals("", mPath)) {
            // If this is the first time to play a video, create a new surfaceview
            mPath = path;
            createSurfaceView();
        } else {
     ...
     */
    private void load() {
        // Recreate imediaplayer every time
        createPlayer();
        try {
...
//        // Enable hard decoding
    ...
    private class LmnSurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            // After the surfaceview is successfully created, load the video
            load();
        }
