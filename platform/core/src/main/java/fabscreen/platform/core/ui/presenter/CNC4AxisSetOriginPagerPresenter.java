...
public class CNC4AxisSetOriginPagerPresenter implements DefaultLifecycleObserver {
    ...
    public CNC4AxisSetOriginPagerPresenter(Context context) {
    ...
    public void setEnabled(boolean enabled) {
        ...
        mBtnSetOriginZ.setEnabled(enabled);
    ...
    private View createPage1(LayoutInflater inflater) {
        View page = inflater.inflate(R.layout.widget_cnc_4axis_set_origin_pager_p1, null);
    ...
    private View createPage2(LayoutInflater inflater) {
        View page = inflater.inflate(R.layout.widget_cnc_4axis_set_origin_pager_p2, null);
    ...
    private Observable<SSTPPacketContent.GcodeResponse> runBoundaryWith(int index, int speed) {
        // We assure that only running boundary in BY dimension.
        if (index == 5) {
    ...
    private void showBoundaryWarningDialog() {
        FabConfirm.create(context)
                ...
                .setDescription(R.string.preview_cnc_rotary_set_origin_dialog_run_boundary_warning)
