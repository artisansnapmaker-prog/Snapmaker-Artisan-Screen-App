...
public class BubbleLayout extends FrameLayout {
    ...
    private int mRadius;
    /**
     * direction for bubble triangle
     */
    @Direction
    private int mDirection;
    /**
     * datum point for bubble triangle
     */
    private Point mDatumPoint;
    /**
     * offset of bubble triangle
     */
    private int mOffset;
    ...
    /**
     * set triangle offset: set the offset for bubble triangle, default layout is centered
     *
     * @param offset
     */
