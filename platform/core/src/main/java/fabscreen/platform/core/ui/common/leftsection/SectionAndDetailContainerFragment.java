...
public abstract class SectionAndDetailContainerFragment extends BaseFragment {
    public static final int SETTINGS_FIRMWARE = 0;
    public static final int SETTINGS_WIFI = 1;
    public static final int SETTINGS_LANGUAGE = 2;
    public static final int SETTINGS_ABOUT = 3;
    public static final int SETTINGS_ATTENDANCE = 4;
    public static final int SETTINGS_TERMS = 5;
    public static final int SETTINGS_MODULE_ASSISTANT = 6;
    public static final int SETTINGS_REMOTE_CONNECTION = 7;


    @BindView(R2.id.rv_sections)
    protected RecyclerView mRvSections;
    protected LeftSectionsAdapter mAdapter;
    ...
    protected abstract LeftSectionsAdapter getSectionsAdapter(List<SectionItem> sectionItems);
